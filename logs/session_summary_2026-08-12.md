...
7. **Release & Documentation Updates**:
   - Incremented version to `v1.5.3` in [VERSION.md](file:///e:/hdd-data/Projects/portfolio-website/docs/VERSION.md).
   - Added v1.5.0 through v1.5.3 highlights in [CHANGELOG.md](file:///e:/hdd-data/Projects/portfolio-website/docs/CHANGELOG.md).
