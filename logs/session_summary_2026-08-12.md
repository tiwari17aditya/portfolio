...
5. **Release & Documentation Updates**:
   - Incremented version to `v1.5.1` in [VERSION.md](file:///e:/hdd-data/Projects/portfolio-website/docs/VERSION.md).
   - Added v1.5.0 and v1.5.1 highlights in [CHANGELOG.md](file:///e:/hdd-data/Projects/portfolio-website/docs/CHANGELOG.md).
